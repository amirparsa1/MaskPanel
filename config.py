...
class NatsSettings(EnvSettings):
    ...
    worker_sync_subject: str = Field(default="maskpanel.worker_sync", validation_alias="NATS_WORKER_SYNC_SUBJECT")
    node_command_subject: str = Field(default="maskpanel.node.command", validation_alias="NATS_NODE_COMMAND_SUBJECT")
    node_rpc_subject: str = Field(default="maskpanel.node.rpc", validation_alias="NATS_NODE_RPC_SUBJECT")
    scheduler_rpc_subject: str = Field(
        default="maskpanel.scheduler.rpc", validation_alias="NATS_SCHEDULER_RPC_SUBJECT"
    )
    node_log_subject: str = Field(default="maskpanel.node.logs", validation_alias="NATS_NODE_LOG_SUBJECT")
    ...
    core_pubsub_channel: str = Field(default="maskpanel_core_hosts", validation_alias="CORE_PUBSUB_CHANNEL")
    host_pubsub_channel: str = Field(default="maskpanel_host_updates", validation_alias="HOST_PUBSUB_CHANNEL")
    telegram_kv_bucket: str = Field(default="maskpanel_telegram", validation_alias="NATS_TELEGRAM_KV_BUCKET")
    node_user_sync_kv_bucket: str = Field(
        default="maskpanel_node_user_sync", validation_alias="NATS_NODE_USER_SYNC_KV_BUCKET"
    )
    node_lifecycle_kv_bucket: str = Field(
        default="maskpanel_node_lifecycle", validation_alias="NATS_NODE_LIFECYCLE_KV_BUCKET"
    )
    scheduler_leader_kv_bucket: str = Field(
        default="maskpanel_scheduler_leader", validation_alias="NATS_SCHEDULER_LEADER_KV_BUCKET"
    )
...
class LoggingSettings(EnvSettings):
    ...
    file_path: str = Field(default="maskpanel.log", validation_alias="LOG_FILE_PATH")
